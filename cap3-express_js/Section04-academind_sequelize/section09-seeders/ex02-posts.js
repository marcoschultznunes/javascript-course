/*
    For posts, i'll generate a UUID. For this, i'll user the following package:
        npm install uuid 
*/
...
const { v4: uuidv4 } = require('uuid'); // The library

module.exports = {
    up: async (queryInterface, Sequelize) => {

        // This is needed to get the user IDs
