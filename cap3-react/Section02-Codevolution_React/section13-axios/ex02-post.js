/*
    Simply build a form like on the last example of section 04 and on submit use axios
    to post the state to the API. The response received should signal the success.
*/
